...
that provide extenssions to 'ggplot2' that construct and return whole `gg` 
...
allows great fexibility in how `data` is displayed or saved.
...
Please report bugs and request new features at (https://bitbucket.org/aphalo/gginnards/issues). Pull requests are welcome at (https://bitbucket.org/aphalo/gginnards).
