...
**NOTE:** The structure of the objects returned by `ggplot2:ggplot2()` is
dependent on the major version of package 'ggplot2'. Thus, the values
returned by the code examples if run by you can differ from those shown here.
...
classe different to `data.frame` can be defined.)
