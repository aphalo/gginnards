...
group is set to `-1` for all observations. As the we override the default geom with `geom_debug()`
...
If we use `geom_debug()` a summary is printed to the console. With two groups,
