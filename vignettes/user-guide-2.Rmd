---
title: "User Guide: 2 Manipulation of ggplots"
...
matching question in [matching question in
Stackoverflow](\url{https://stackoverflow.com/questions/13407236/remove-a-layer-from-a-ggplot2-chart}).
...
the use of RAM can add up, and occasionally printing of each plot can slow down. 
...
It is yet not clear to me when R does make a copy of the data embedded in a
...
In any case when saving `ggplot` objects to disk avoiding to carry along unused
