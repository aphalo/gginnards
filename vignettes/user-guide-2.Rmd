...
Although their definitions do not rely on code internal to 'ggplot2', they 
rely on the internal structure of objects belonging to class `gg` and `ggplot`.
Consequently, long-term backwards compatibility cannot be guaranteed, or even
expected.
...
Layers in a plot are stored in a list. The output of `summary()` is compact.
